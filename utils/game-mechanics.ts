...
export interface InitialGameState {
  ...
  lastClickCooldownTimestamp: number | null;
...
export interface GameState extends InitialGameState {
  ...
  setLastClickCooldownTimestamp: (timestamp: number | null) => void;
}
...
export const createGameStore = (initialState: InitialGameState) => create<GameState>((set) => ({
  ...
  setLastClickCooldownTimestamp: (timestamp) => set({ lastClickCooldownTimestamp: timestamp }),
}));
