...
export default function Friends() {
  ...
  const shareText = `🚀 Earn 5 USDT every 5 minutes with USDT \n Clicker Pro 💰!`;
  ...
  }, [getInviteLink, shareText, showToast]);
          ...
          <div className="mt-[2px] bg-[#1d2025] rounded-t-[46px] h-full overflow-y-auto no-scrollbar">
            <div className="px-4 pt-1 pb-36">
              <div className="relative">
                          ...
                          <li key={referral.id} className="flex justify-between items-center bg-[#272a2f] rounded-lg p-4">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-400">{referral.levelName} • {formatNumber(referral.points)} USDT</p>
                              </div>
                            </div>
                ...
                {showShareOptions && (
                  <div className="fixed bottom-40 left-1/2 transform -translate-x-1/2 w-full max-w-xl z-40 px-4">
                    <div className="bg-[#272a2f] rounded-xl p-3 grid grid-cols-4 gap-2">
                      <button onClick={openTelegramShare} className="py-2 rounded-lg bg-[#229ED9] text-white font-bold">Telegram</button>
                      <button onClick={openWhatsAppShare} className="py-2 rounded-lg bg-[#25D366] text-white font-bold">WhatsApp</button>
                      <button onClick={openTwitterShare} className="py-2 rounded-lg bg-black text-white font-bold">X</button>
                      <button onClick={openFacebookShare} className="py-2 rounded-lg bg-[#1877F2] text-white font-bold">Facebook</button>
                    </div>
                  </div>
                )}
